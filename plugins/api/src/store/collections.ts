...
export class CollectionStore extends Context.Tag("CollectionStore")<
  CollectionStore,
  {
    ...
    readonly create: (collection: {
      name: string;
      slug: string;
      description?: string;
      image?: string;
      badge?: string;
    }) => Effect.Effect<Collection, Error>;
    readonly update: (
      slug: string,
      data: {
        name?: string;
    ...
    readonly updateFeaturedProduct: (
      slug: string,
    ...
    readonly setProductCollections: (
      productId: string,
...
export const CollectionStoreLive = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const rowToCollection = (
      row: typeof schema.collections.$inferSelect,
    ...
    const getFeaturedProduct = async (
      productId: string | null,
    ): Promise<CollectionFeaturedProduct | undefined> => {
          ...
          try: async () => {
            ...
            await db
              ...
              .set({
                ...
                ...(data.carouselDescription !== undefined && {
