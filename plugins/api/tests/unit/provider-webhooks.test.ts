...
} from "../../src/services/fulfillment/webhook";
...
describe("shared webhook processors", () => {
  it("processes a printful shipment webhook through the shared fulfillment helper", async () => {
    const updateStatusCalls: Array<
      [string, string, string | undefined, string | undefined, Record<string, unknown> | undefined]
    > = [];
    const updateTrackingCalls: Array<
      [string, unknown[], string | undefined, Record<string, unknown> | undefined]
    > = [];
